...
function getFormatDoc(smile){
  $.get({
    url: 'http://127.0.0.1:8000/congeners/'+smile,
    async:false,
    success: function(response) {
      console.log('http://127.0.0.1:8000/congeners/', response);
      let responseData = response.data;
      showFormat(responseData)
    }
  });
...
function showFormat(textFormat){
